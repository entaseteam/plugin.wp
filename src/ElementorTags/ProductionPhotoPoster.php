...
class ProductionPhotoPoster extends \Elementor\Core\DynamicTags\Data_Tag 
{
    private static $tagName = 'entase_photo_poster';
    private static $tagTitle = 'Poster photo - Entase';
    ...
    public function get_value($options=[])
    {
        ...
        return ['url' => \Entase\Plugins\WP\Shortcodes\Photo::Do($atts, '', 'entase_photo_poster')]; 
    }
